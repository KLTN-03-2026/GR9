  ...
  return (
    <div className="flex flex-col lg:flex-row gap-4 items-center justify-between bg-white p-6 rounded-3xl shadow-sm border border-slate-100">
      <div className="flex flex-col md:flex-row items-center gap-4 w-full lg:w-auto">
        <div className="w-full md:w-56">
          <Select value={category} onValueChange={onCategoryChange}>
            <SelectTrigger className="w-full h-12 rounded-2xl border-none bg-slate-50 font-bold text-slate-600 focus:ring-2 focus:ring-primary/20">
        ...
        <div className="relative w-full md:w-80">
          ...
          <Input
            ...
            className="pl-12 pr-6 h-12 bg-slate-50 border-none rounded-2xl focus-visible:ring-2 focus-visible:ring-primary/20 text-sm"
      ...
      <div className="w-full lg:w-auto">
        ...
        >
          <span className="bg-white/20 rounded-full p-1 mr-2 group-hover:rotate-90 transition-transform">
