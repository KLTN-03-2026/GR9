                ...
                <div className="relative flex flex-col gap-6 xl:flex-row xl:items-end xl:justify-between">
                    ...
                    <div className="flex flex-col gap-4 sm:flex-row sm:items-center">
                        ...
                        <Button
                            ...
                            className="h-12 rounded-2xl bg-gradient-to-br from-primary to-primary-container px-6 font-headline text-sm font-bold text-primary-foreground shadow-lg shadow-primary/15 hover:-translate-y-0.5 hover:shadow-xl"
                        >
