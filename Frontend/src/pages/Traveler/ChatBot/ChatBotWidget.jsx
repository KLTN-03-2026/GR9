  ...
  return (
    <>
      ...
      >
        ...
        {!minimized ? (
          <>
            <div className="min-h-0 flex-1 space-y-4 overflow-y-auto overscroll-contain bg-[radial-gradient(circle_at_top_left,rgba(20,184,166,0.10),transparent_34%),linear-gradient(180deg,#f8fafc_0%,#ffffff_100%)] px-4 py-4">
