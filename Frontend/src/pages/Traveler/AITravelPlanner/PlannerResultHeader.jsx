      ...
      actions={
        <>
          ...
          >
            ...
            <span>{t("planner.savedTrips")}</span>
          </Button>
          <Button
            type="button"
            onClick={onSaveTrip}
          ...
          >
            ...
            <span>
              {isSavingTrip ? t("planner.saving") : isTripSaved ? t("planner.saved") : t("planner.saveTrip")}
            </span>
          </Button>
          <Button
            type="button"
          ...
          >
            ...
            <span>
              {isSendingToProviders
                ? t("planner.sending")
                : isSentToProviders
                  ? t("planner.sentToProviders")
                  : t("planner.sendToProviders")}
            </span>
          </Button>
        </>
      }
