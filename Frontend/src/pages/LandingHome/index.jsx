...
const platformCards = [
    {
        ...
        description: "See knowledge flow, escalation pressure, and team throughput in one cinematic operational view.",
    },
    {
...
const testimonials = [
    {
        quote: "The new orchestration layer feels like a command center for the whole business, not just another chatbot.",
        name: "Linh Tran",
        role: "Chief Transformation Officer",
    },
    {
        quote: "Our IT and Finance teams now operate on the same context stream. Escalations dropped almost immediately.",
        name: "Daniel Vo",
        role: "VP of Enterprise Systems",
    },
    {
        quote: "It delivers the premium visual language our leadership wanted, while actually making workflows faster.",
        name: "Mai Nguyen",
      ...
      `}</style>
            ...
            <div className="neural-shell relative overflow-hidden">
                ...
                <motion.header
                    ...
                    className="relative overflow-hidden px-6 pb-24 pt-32 md:pt-36"
                >
                    <div className="mx-auto grid max-w-7xl gap-16 lg:grid-cols-[1.05fr_0.95fr] lg:items-center">
                        <div className="relative z-10 max-w-3xl">
                            ...
                            <motion.h1
                                variants={fadeUp}
                                className="mt-8 font-heading text-5xl leading-[0.95] font-extrabold tracking-[-0.04em] text-[var(--hero-text)] md:text-7xl xl:text-[5.6rem]"
                            >
                                Build a
                            ...
                            <motion.p
                                variants={fadeUp}
                                className="mt-7 max-w-2xl text-lg leading-8 text-[var(--hero-muted)] md:text-xl"
                            >
                                A multi-layer 3D intelligence experience where HR, IT, Finance, and Operations become
                                glowing data nodes streaming live context into one trusted AI core.
                            </motion.p>
                            ...
                            <div className="hero-scene relative mx-auto h-[680px] w-full max-w-[720px]">
                                <div className="scene-drift absolute inset-0">
                                    ...
                                    <motion.div
                                        ...
                                        className="core-pulse glass-panel absolute left-1/2 top-1/2 h-44 w-44 -translate-x-1/2 -translate-y-1/2 rounded-full"
                                    >
                                    ...
                                    <div className="glass-panel absolute bottom-5 left-5 w-48 rounded-[1.6rem] p-4">
                                        ...
                                        <p className="mt-3 text-xs text-[var(--hero-muted)]">
                                            Continuous optical knowledge flow into the central AI reasoning core.
                                        </p>
                                    </div>
                                    ...
                                    <div className="glass-panel absolute right-4 top-10 w-52 rounded-[1.6rem] p-4">
                                        ...
                                        <p className="mt-4 text-xs text-[var(--hero-muted)]">
                                            Thousands of micro-signals rendered as a living 3D enterprise web.
                                        </p>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div className="mx-auto max-w-7xl">
                        <div className="mb-12 max-w-3xl">
                            ...
                            <h2 className="mt-4 font-heading text-4xl font-extrabold tracking-[-0.03em] text-[var(--hero-text)] md:text-5xl">
                                Glassmorphism surfaces wrapped around a living knowledge universe.
                            </h2>
                            <p className="mt-5 max-w-2xl text-lg leading-8 text-[var(--hero-muted)]">
                                Every card, control, and data lens is designed to float above a detailed neural backdrop
                    ...
                    <div className="mx-auto grid max-w-7xl gap-10 lg:grid-cols-[0.9fr_1.1fr]">
                        <div>
                            ...
                            <p className="mt-5 max-w-xl text-lg leading-8 text-[var(--hero-muted)]">
                                The visual system is not decoration. It mirrors how knowledge enters, transforms, and
                                propagates through the enterprise.
                            </p>
                        </div>
                        ...
                        <motion.div variants={staggerContainer} className="grid gap-6 lg:grid-cols-3">
                            {testimonials.map((item) => (
                                ...
                                >
                                    ...
                                    <p className="mt-5 text-base leading-7 text-[var(--hero-text)]">{item.quote}</p>
                                    <div className="mt-8">
                        ...
                        <div className="glass-panel relative overflow-hidden rounded-[2.5rem] p-10 text-center md:p-16">
                            ...
                            <div className="relative z-10 mx-auto max-w-3xl">
                                ...
                                <p className="mt-6 text-lg leading-8 text-[var(--hero-muted)]">
                                    Launch a landing experience that feels like enterprise-grade software cinema:
                                    immersive, credible, and conversion-focused.
                                </p>
                ...
                <motion.footer
                    ...
                    className="border-t border-white/8 px-6 pb-10 pt-16"
                >
                    <div className="mx-auto grid max-w-7xl gap-10 md:grid-cols-4">
                        <div>
                            ...
                            <p className="mt-4 max-w-sm text-sm leading-7 text-white/60">
                                A premium AI orchestration experience built around living knowledge, cinematic light,
