...
const InfomationCard = ({ title, description, icon: Icon, children }) => {
  return (
    <Card className="overflow-hidden rounded-[30px] !border-[#e8ded0] !bg-white/[0.92] !py-0 !text-[#213033] shadow-[0_24px_70px_rgba(38,33,28,0.08)] backdrop-blur-sm">
      <CardHeader className="border-b !border-[#efe7dc] !bg-transparent px-6 py-5 sm:px-7">
